                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right d-none d-md-inline">
                        <ul class="header-social-network d-inline-block list-inline mr-15">
                            ...
                            <li class="list-inline-item" data-href="{{url('/post')}}/{{$news_detail->slug}}">
                                <a class="social-icon fb text-xs-center" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post')}}/{{$news_detail->slug}}">
            ...
            <article class="entry-wraper mb-50">
                ...
                <div class="single-social-share clearfix wow fadeIn animated">
                    <div class="entry-meta meta-1 font-small color-grey float-left mt-10">
                        <span class="hit-count mr-15"><i class="elegant-icon icon_comment_alt mr-5"></i>182 пікірлер</span>
                        <span class="hit-count mr-15"><i class="elegant-icon icon_like mr-5"></i>268 ұнату</span>
                ...
                <div class="author-bio p-30 mt-50 border-radius-10 bg-white wow fadeIn animated">
                    <div class="author-image mb-30">
                        <a href="{{route('newsAuthor', $news_detail->admin->name)}}">
                            <img {{ asset('storage/uploads/admin/'. $news_detail->image) }} alt="" class="avatar">
                        </a>
                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="post-thumb position-relative border-radius-5">
                                                ...
                                                <ul class="social-share">
                                                    ...
                                                    <li class="list-inline-item" data-href="{{url('/post')}}/{{$news_detail->slug}}"><a class="social-icon fb text-xs-center" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post')}}/{{$news_detail->slug}}"><i class="elegant-icon social_facebook"></i></a></li>
                                        ...
                                        <div class="col-md-8 align-self-center">
                                            <div class="post-content">
                                                ...
                                                <h5 class="post-title font-weight-900 mb-20">
                                                    <a href="{{route('WelcomeNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                </h5>
                ...
                <div class="single-more-articles border-radius-5">
                    <div class="widget-header-2 position-relative mb-30">
                        <h5 class="mt-5 mb-30">Сізді қызықтыруы мүмкін</h5>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" name="comment" id="sendermessage" cols="20" rows="7" placeholder="Пікіріңіз"></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control" name="name"  id="sendername" type="text" placeholder="Есіміңіз">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control" name="email" id="emailaddress" type="email" placeholder="Email">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                @foreach($blog_Last_index as $news)
                                    <li class="mb-30">
                                        <div class="d-flex hover-up-2 transition-normal">
                                            ...
                                            <div class="post-content media-body">
                                                <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                                    <a href="{{route('BlogNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                </h6>
                                                <div class="entry-meta meta-1 float-left font-x-small text-uppercase">
                                                    <span class="post-on">{{ $date->day }} {{ $date->translatedFormat('F')}} {{ $date->year }}</span>
                                                    <span class="post-by has-dot">{{$news->view_count}} Көрілім</span>
                                ...
                                @foreach($currency_Last_index as $news)
                                    <li class="mb-30">
                                        <div class="d-flex hover-up-2 transition-normal">
                                            ...
                                            <div class="post-content media-body">
                                                <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                                    <a href="{{route('CryptoCurrencyNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                </h6>
                                                <div class="entry-meta meta-1 float-left font-x-small text-uppercase">
                                                    <span class="post-on">{{ $date->day }} {{ $date->translatedFormat('F')}} {{ $date->year }}</span>
                                                    <span class="post-by has-dot">{{$news->view_count}} Көрілім</span>
