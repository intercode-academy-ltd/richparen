@extends('layouts.app')
@section('title') {{'Codeforces'}}@endsection
@section('content')
    ...
    <main>
        ...
        <div class="archive-header pt-50">
            <div class="container">
                <h2 class="font-weight-900">CodeForces</h2>
                    ...
                    <div class="col-lg-8">
                        <div class="post-module-3">
                            <div class="loop-list loop-list-style-1">
                                @foreach($all_post_codeforces as $news)
                                        ...
                                        <div class="col-md-4">
                                            <div class="post-thumb position-relative border-radius-5">
                                                ...
                                                <ul class="social-share">
                                                    ...
                                                    <li><a class="fb" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/codeforces')}}/{{$news->slug}}" title="Share on Facebook"><i class="elegant-icon social_facebook"></i></a></li>
                                            ...
                                            <div class="post-content">
                                                <div class="entry-meta meta-0 font-small mb-10">
                                                    @foreach($codeforces as $nav)
                                                        <a href="{{$nav->slug}}">
                                                            <span style="font-family: 'Georgia, serif'" class="post-cat text-primary">{{$nav->category_name}}</span>
                                                        </a>
                                                    @endforeach
                                                </div>
                        ...
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget-latest-posts mb-50 wow fadeInUp animated">
                                ...
                                <div class="post-block-list post-module-1">
                                    <ul class="list-post">
                                        @foreach($acmp_last_codeforces as $news)
                                        ...
                                        @endforeach
                                        @foreach($algorithm_last_codeforces as $news)
                                                <li class="mb-30 wow fadeInUp animated">
                                                    <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                        <div class="post-content media-body">
                                                            <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                        ...
                                        @endforeach
                                        @foreach($informatics_last_codeforces as $news)
                                                <li class="mb-30 wow fadeInUp animated">
                                                    <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                        <div class="post-content media-body">
                                                            <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                        ...
                                        @endforeach
                                        @foreach($gamedev_last_codeforces as $news)
