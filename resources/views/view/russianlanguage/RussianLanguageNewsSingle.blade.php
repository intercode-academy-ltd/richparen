                                        ...
                                        <div class="col-md-4">
                                            <div class="post-thumb position-relative border-radius-5">
                                                <div class="img-hover-slide border-radius-5 position-relative">
                                                    <a class="img-link" href="{{route('RussianLanguageNewsSingle', $news->slug)}}">
                                                        <img class="img-link" src="{{ asset('storage/uploads/news/'. $news->image) }}" alt="">
                                                    </a>
                                                </div>
                                                <ul class="social-share">
                                                    <li><a href="#"><i class="elegant-icon social_share"></i></a></li>
                                                    <li class="list-inline-item" data-href="{{url('/post/russian-language')}}/{{$news_detail->slug}}"><a class="social-icon fb text-xs-center" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/russian-language')}}/{{$news_detail->slug}}"><i class="elegant-icon social_facebook"></i></a></li>
                                        ...
                                        <div class="col-md-8 align-self-center">
                                            <div class="post-content">
                                                ...
                                                <h5 class="post-title font-weight-900 mb-20">
                                                    <a href="{{route('RussianLanguageNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                </h5>
