            ...
            <article class="entry-wraper mb-50">
                ...
                <div class="single-social-share clearfix wow fadeIn animated">
                    ...
                    <ul class="header-social-network d-inline-block list-inline float-md-right mt-md-0 mt-4">
                        ...
                        <li class="list-inline-item" data-href="{{url('/post/cplusplus')}}/{{$news_detail->slug}}"><a class="social-icon fb text-xs-center" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/cplusplus')}}/{{$news_detail->slug}}"><i class="elegant-icon social_facebook"></i></a></li>
                                        ...
                                        <div class="col-md-8 align-self-center">
                                            <div class="post-content">
                                                ...
                                                <h5 class="post-title font-weight-900 mb-20">
                                                    <a href="{{route('CplusplusNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                </h5>
