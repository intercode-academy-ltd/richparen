@extends('layouts.app')
@section('title') {{'C++ - проект '}}@endsection
@section('content')
    ...
    <main>
        ...
        <div class="archive-header pt-50">
            <div class="container">
                <h2 class="font-weight-900">C++ проект</h2>
                    ...
                    <div class="col-lg-8">
                        <div class="post-module-3">
                            <div class="loop-list loop-list-style-1">
                                @foreach($last_all_project_cplusplus as $news)
                                            ...
                                            <div class="col-md-4">
                                                <div class="post-thumb position-relative border-radius-5">
                                                    ...
                                                    <ul class="social-share">
                                                        ...
                                                        <li><a class="fb" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/cplusplus')}}/{{$news->slug}}" title="Share on Facebook" target="_blank"><i class="elegant-icon social_facebook"></i></a></li>
                        ...
                        <div class="pagination-area mb-30 wow fadeInUp animated">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-start">
                                    {{ $last_all_project_cplusplus->links() }}
                                </ul>
                            </nav>
                        </div>
                    </div>
