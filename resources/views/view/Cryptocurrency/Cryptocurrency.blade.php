@extends('layouts.app')
@section('title') {{'Криптовалюта'}}@endsection
@section('content')
    ...
    <main>
        ...
        <div class="archive-header pt-50">
            <div class="container">
                <h2 class="font-weight-900">Криптовалюта</h2>
            ...
            <div class="container">
                <div class="loop-grid mb-30">
                    <div class="row">
                            ...
                            <div class="carausel-post-1 hover-up border-radius-10 overflow-hidden transition-normal position-relative wow fadeInUp animated">
                                ...
                                <div class="slide-fade">
                                    <div class="position-relative post-thumb">
                                        @foreach($crypto_view_count as $news)
                                        <div class="thumb-overlay img-hover-slide position-relative">
                                            ...
                                            <div class="post-content-overlay text-white ml-30 mr-30 pb-30">
                                                <div class="entry-meta meta-0 font-small mb-20">
                                                    ...
                                                    <a href="{{$nav->slug}}">
                                                        <span style="font-family: 'Georgia, serif'" class="post-cat text-info text-uppercase">{{$nav->category_name}}</span>
                                                    </a>
                                                    @endforeach
                                                    <span class="post-cat text-success text-uppercase">{{$news->subcat}}</span>
                                                </div>
                                                <h3 class="post-title font-weight-900 mb-20">
                                                    <a class="text-white" style="font-family: 'Georgia, serif'" href="{{route('CryptoCurrencyNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                </h3>
                        ...
                        @foreach($informatics_crypto as $news)
                    ...
                    <div class="col-lg-8">
                        <div class="post-module-3">
                            <div class="loop-list loop-list-style-1">
                                @foreach($all_post_crypto as $news)
                        ...
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget-latest-posts mb-50 wow fadeInUp animated">
                                ...
                                <div class="post-block-list post-module-1">
                                    <ul class="list-post">
                                        @foreach($codeforces_view_count as $news)
                                            <li class="mb-30 wow fadeInUp animated">
                                                <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                    <div class="post-content media-body">
                                                        <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                                            <a href="{{route('CodeforcesNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                        </h6>
                                                        <div class="entry-meta meta-1 float-left font-x-small text-uppercase">
                                        ...
                                        @foreach($algorithm_view_count as $news)
                                            <li class="mb-30 wow fadeInUp animated">
                                                <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                    <div class="post-content media-body">
                                                        <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                                            <a href="{{route('AlgorithmNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                        </h6>
                                                        <div class="entry-meta meta-1 float-left font-x-small text-uppercase">
                                                            <span class="post-on">{{ $date->day }} {{ $date->translatedFormat('F')}} {{ $date->year }}</span>
                                                            <span class="hit-count has-dot">{{$news->view_count}} Көрілім</span>
                                        ...
                                        @endforeach
                                        @foreach($acmp_view_count as $news)
                                            <li class="mb-30 wow fadeInUp animated">
                                                <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                    <div class="post-content media-body">
                                                        <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                                            <a href="{{route('ACMPNewsSingle', $news->slug)}}">{{ $news->news_title }}</a>
                                                        </h6>
                                                        <div class="entry-meta meta-1 float-left font-x-small text-uppercase">
                                                            <span class="post-on">{{ $date->day }} {{ $date->translatedFormat('F')}} {{ $date->year }}</span>
                                                            <span class="hit-count has-dot">{{$news->view_count}} Көрілім</span>
