            ...
            <article class="entry-wraper mb-50">
                ...
                <div class="single-social-share clearfix wow fadeIn animated">
                    ...
                    <ul class="header-social-network d-inline-block list-inline float-md-right mt-md-0 mt-4">
                        ...
                        <li class="list-inline-item" data-href="{{url('/post/hacking')}}/{{$news_detail->slug}}">
                            <a class="social-icon fb text-xs-center" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/hacking')}}/{{$news_detail->slug}}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="post-thumb position-relative border-radius-5">
                                                ...
                                                <ul class="social-share">
                                                    ...
                                                    <li class="list-inline-item" data-href="{{url('/post/hacking')}}/{{$news_detail->slug}}"><a class="social-icon fb text-xs-center" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/hacking')}}/{{$news_detail->slug}}"><i class="elegant-icon social_facebook"></i></a></li>
