@extends('layouts.app')
@section('title') {{'java - проект '}}@endsection
@section('content')
    ...
    <main>
        ...
        <div class="archive-header pt-50">
            <div class="container">
                <h2 class="font-weight-900">Java проект</h2>
                <div class="breadcrumb">
                    <a href="{{asset('')}}" rel="nofollow">Басты бет</a>
                    <span></span> java проект
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="post-module-3">
                            <div class="loop-list loop-list-style-1">
                                @foreach($last_all_project_java as $news)
                                            ...
                                            <div class="col-md-4">
                                                <div class="post-thumb position-relative border-radius-5">
                                                    ...
                                                    <ul class="social-share">
                                                        ...
                                                        <li><a class="fb" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/java')}}/{{$news->slug}}" title="Share on Facebook" target="_blank"><i class="elegant-icon social_facebook"></i></a></li>
