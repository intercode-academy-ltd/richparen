@extends('layouts.app')
@section('title') {{'Кітап | Бизнес  '}}@endsection
@section('content')
    ...
    <main>
        ...
        <div class="archive-header pt-50">
            <div class="container">
                <h2 class="font-weight-900">Бизнес кітаптары</h2>
                <div class="breadcrumb">
                    <a href="{{asset('')}}" rel="nofollow">Басты бет</a>
                    <span></span> Бизнес кітаптары
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="post-module-3">
                            <div class="loop-list loop-list-style-1">
                                @foreach($books_all_business as $news)
