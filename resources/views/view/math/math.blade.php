@extends('layouts.app')
@section('title') {{' Математика '}}@endsection
@section('content')
    ...
    <main>
        ...
        <div class="archive-header pt-50">
            <div class="container">
                <h2 class="font-weight-900">Математика</h2>
                                            ...
                                            <div class="col-md-4">
                                                <div class="post-thumb position-relative border-radius-5">
                                                    ...
                                                    <ul class="social-share">
                                                        ...
                                                        <li><a class="fb" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/math')}}/{{$news->slug}}" title="Share on Facebook"><i class="elegant-icon social_facebook"></i></a></li>
                                            ...
                                            <div class="col-md-8 align-self-center">
                                                <div class="post-content">
                                                    <div class="entry-meta meta-0 font-small mb-10">
                                                        ...
                                                        @endforeach
                                                            <span class="post-cat text-info">{{$news->subcat}}</span>
                                                    </div>
                        ...
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget-latest-posts mb-50 wow fadeInUp animated">
                                ...
                                <div class="post-block-list post-module-1">
                                    <ul class="list-post">
                                        @foreach($enlan_last_math as $news)
                                        ...
                                        @endforeach
                                        @foreach($codeforces_last_math as $news)
                                            <li class="mb-30 wow fadeInUp animated">
                                                <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                    <div class="post-content media-body">
                                                        <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                        ...
                                        @endforeach
                                        @foreach($business_last_math as $news)
                                            <li class="mb-30 wow fadeInUp animated">
                                                <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                    <div class="post-content media-body">
                                                        <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                        ...
                                        @endforeach
                                        @foreach($cplusplus_last_math as $news)
