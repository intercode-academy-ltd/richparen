@extends('layouts.app')
@section('title') {{' Ағылшын тілі курсы '}}@endsection
@section('content')
    ...
    <main>
        ...
        <div class="archive-header pt-50">
            <div class="container">
                <h2 class="font-weight-900">Ағылшын тілі</h2>
                <div class="breadcrumb">
                    <a href="{{asset('')}}" rel="nofollow">Басты бет</a>
                    <span></span> Ағылшын тілі
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="post-module-3">
                            <div class="loop-list loop-list-style-1">
                                @foreach($all_post_enlan as $news)
                                        ...
                                        <div class="col-md-4">
                                            <div class="post-thumb position-relative border-radius-5">
                                                ...
                                                <ul class="social-share">
                                                    ...
                                                    <li><a class="fb" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('/post/english-language')}}/{{$news->slug}}" title="Share on Facebook"><i class="elegant-icon social_facebook"></i></a></li>
                        ...
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget-latest-posts mb-50 wow fadeInUp animated">
                                ...
                                <div class="post-block-list post-module-1">
                                    <ul class="list-post">
                                        @foreach($rulan_last_enlan as $news)
                                        ...
                                        @endforeach
                                        @foreach($math_last_enlan as $news)
                                            <li class="mb-30 wow fadeInUp animated">
                                                <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                    <div class="post-content media-body">
                                                        <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                        ...
                                        @endforeach
                                        @foreach($acmp_last_enlan as $news)
                                            <li class="mb-30 wow fadeInUp animated">
                                                <div class="d-flex bg-white has-border p-25 hover-up transition-normal border-radius-5">
                                                    <div class="post-content media-body">
                                                        <h6 class="post-title mb-15 text-limit-2-row font-medium">
                                        ...
                                        @endforeach
                                        @foreach($hacking_last_enlan as $news)
