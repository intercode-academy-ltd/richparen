                            ...
                            <div class="col-md-12">
                                ...
                                <form action="{{ route('news.update', $news->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="news_title" value="{{ $news->news_title }}" class="form-control" id="title" placeholder="Enter title">
                                    </div>

                                    <div class="form-group">
                                        <label for="subcat">Sub Cat</label>
                                        <input type="text" name="subcat" value="{{ $news->subcat }}" class="form-control" id="subcat" placeholder="Enter subcat">
                                    </div>


                                    <div class="form-group">
                                        <textarea name="news_content" id="summernote"> {{ $news->news_content }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="post" value="{{ $news->post }}" class="form-control" id="post" placeholder="post or no">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" value="{{$news->file_name}}" id="file" name="file_name" multiple>
                                    </div>
