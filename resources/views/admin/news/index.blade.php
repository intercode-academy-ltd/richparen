...
<head>
    ...
    <title>Manage Posts | WikiBlogger</title>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <button class="btn btn-primary"><a href="{{route('news.add')}}" style="color: white;">Add News</a></button>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($news as $data)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>
                                                <img src="{{ asset('/storage/uploads/news/'.$data->image) }}" alt="" width="100px">
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ route('news.edit', $data->id ) }}"><i class="fas fa-edit"></i></a>&nbsp;
