                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form method="post" action="{{route('socialUpdate', $social->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">FaceBook URL</label>
                                        <div class="col-lg-9">
                                            <input name="facebook" class="form-control"  type="url" value="{{$social->facebook}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input name="twitter" class="form-control"  type="url"value="{{$social->twitter}}" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input name="instagram" class="form-control"  type="url" value="{{$social->instagram}}">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Telegram URL</label>
                                        <div class="col-lg-9">
                                            <input name="telegram" class="form-control"  type="url" value="{{$social->telegram}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input name="youtube" class="form-control"  type="url" value="{{$social->youtube}}">
                                        </div>
                                    </div>
