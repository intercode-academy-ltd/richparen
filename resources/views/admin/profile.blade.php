                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                     src="{{ asset('storage/uploads/admin/'. $current_user->image) }}" alt="{{ $current_user->name }}">
                            </div>
                            <h3 class="profile-username text-center">{{ $current_user->name }} {{ $current_user->surname }}</h3>
                            <p class="text-muted text-center">{{$current_user->account}}</p>
...
3 Jan. 2014
                                ...
                                <div class="tab-pane" id="settings">
                                    ...
                                    <form class="form-horizontal" method="post" action="{{ route('profileUpdate', $admin->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">Account</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="account" value="{{ $admin->account }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <br>
                                            <img src="{{ asset('storage/uploads/admin/'.$admin->image) }}" alt="" width="150" id="one">
                                        </div>
