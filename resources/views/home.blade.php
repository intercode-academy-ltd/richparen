            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    ...
                    <form class="input-group form-subcriber mt-30 d-flex">
                        <input pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}"  name="subscriber_email"  id="subscriber_email" required="" type="email" class="form-control bg-white font-small" placeholder="Электрондық поштаңызды енгізіңіз">
                        <button onclick="addSubscriber();" class="btn bg-primary text-white" type="submit">Жазылу</button>
                    </form>

                </div>
                <div class="col-lg-6 text-right d-none d-lg-block">
                    @foreach($main_image as $theme)
                        <img src="{{asset('storage/uploads/theme/'.$theme->main_image)}}" alt="">
                    @endforeach
                </div>
            </div>
        </div>
